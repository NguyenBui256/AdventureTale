...
public class Character {
            ...
            String JumpingRightPath)
    {
        if (JumpingLeftPath != null) {
            ...
            rolls[0] = new Animation(0.5f, idleLeft[0]);
            rolls[1] = new Animation(0.5f, idleRight[0]);
            ...
            rolls[0] = new Animation(0.08f, idleLeft[0]);
            rolls[1] = new Animation(0.08f, idleRight[0]);
